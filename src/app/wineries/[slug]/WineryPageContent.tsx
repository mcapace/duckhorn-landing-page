          ...
          >
            ...
            <div className="relative w-full">
              <div className="relative w-full">
                ...
                <div className="hidden md:block absolute inset-x-0 bottom-0 min-h-[36%] pt-[8%] pb-5 px-4 sm:px-6 flex flex-col justify-end bg-gradient-to-t from-white via-white/90 to-transparent">
