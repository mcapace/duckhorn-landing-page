        ...
        <div className="max-w-[1400px] mx-auto px-6 md:px-12 lg:px-20 py-12 md:py-16">
          ...
          {section1 && (
            ...
            >
              ...
              <p className="text-[#3D3D3D] text-base md:text-lg leading-[1.75] w-full" style={isKostaBrowne ? { fontFamily: "var(--font-serif)" } : undefined}>{section1.body}</p>
            </motion.section>
          )}
          {section2 && (
            <motion.section
            ...
            >
              ...
              <p className="text-[#3D3D3D] text-base md:text-lg leading-[1.75] w-full">{section2.body}</p>
            </motion.section>
          )}
          {isKostaBrowne ? (
            <motion.div
          ...
          >
            ...
            <div className="relative w-full">
              <div className="relative w-full">
                ...
                <div className="hidden md:block absolute inset-x-0 bottom-0 min-h-[50%] pt-[28%] pb-8 px-4 sm:px-6 flex flex-col justify-end bg-gradient-to-t from-white via-white/85 to-transparent">
